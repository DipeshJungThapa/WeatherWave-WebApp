...
#     # path("list_users/", UserViewset.as_view({'get': 'list'}), name="list_users"), # Commented out, but handled by router
#     path('weather/', get_current_weather),
#     path('default_weather/',get_current_weather_default),
#     path('aqi/', get_aqi),
#     # Temporarily commenting out ML prediction views
#     # path('predict_geo/', predict_geo),  # <-- Correctly commented
#     # path('predict_city/', predict_city), # <-- Correctly commented
...
urlpatterns = router.urls + [
    ...
    path('api/', include([
        ...
        # Uncomment these if you enable the prediction views in forecast/views.py
